...
- Use webdev_write_file for new files and full-file replacements.
...
- Use webdev_patch_file only for exact search/replace edits. If unsure, use webdev_write_file.
