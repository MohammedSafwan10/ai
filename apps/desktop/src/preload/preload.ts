...
const api: PrivoraDesktopApi = {
  ...
  steerTurn: (input: SteerTurnInput) => ipcRenderer.invoke(channels.steerTurn, input),
  ...
  downloadGeneratedImage: (input: GeneratedImageFileInput) => ipcRenderer.invoke(channels.downloadGeneratedImage, input),
  revealGeneratedImage: (input: GeneratedImageFileInput) => ipcRenderer.invoke(channels.revealGeneratedImage, input),
